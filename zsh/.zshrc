...
plugins=(git zsh-autosuggestions zsh-syntax-highlighting alias-tips autoupdate autojump)
...
# Toggle xdebug
alias exd="$HOME/projects/dotfiles/php/enable-xdebug.sh"
alias dxd="$HOME/projects/dotfiles/php/disable-xdebug.sh"
